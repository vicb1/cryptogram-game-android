...
public class TestPlayerSelectCryptogram {

    @Rule
    public ActivityTestRule<LoginActivity> mActivityTestRule = new ActivityTestRule<>(LoginActivity.class);

    @Test
    public void testPlayerSelectCryptogram() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.game_title), withText("Something to eat 1"),
                        childAtPosition(
                                allOf(withId(R.id.container),
                                        childAtPosition(
                                                withId(android.R.id.content),
                                ...
                                0),
                        isDisplayed()));
        textView.check(matches(withText("Something to eat 1")));
    }
