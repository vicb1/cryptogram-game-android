...
public class Test5FailedCryptoAttempts {

    @Rule
    public ActivityTestRule<LoginActivity> mActivityTestRule = new ActivityTestRule<>(LoginActivity.class);

    @Test
    public void test5FailedCryptoAttempts() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.game_attempts), withText("Attempts Left: 15"),
                        childAtPosition(
                                allOf(withId(R.id.container),
                                        childAtPosition(
                                                withId(android.R.id.content),
                                ...
                                1),
                        isDisplayed()));
        textView.check(matches(withText("Attempts Left: 15")));
