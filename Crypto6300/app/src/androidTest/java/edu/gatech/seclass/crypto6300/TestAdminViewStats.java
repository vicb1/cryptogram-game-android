...
public class TestAdminViewStats {

    @Rule
    public ActivityTestRule<LoginActivity> mActivityTestRule = new ActivityTestRule<>(LoginActivity.class);

    @Test
    public void testAdminViewStats() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.login_input), withText("owalla3"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("CryptoAdmin"));
        ...
        ViewInteraction appCompatButton6 = onView(
                allOf(withId(R.id.play_stats_button), withText("Player Statistics"),
                        childAtPosition(
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.admin_stat_txt_numofwon), withText("1"),
                        childAtPosition(
                                allOf(withId(R.id.admin_stat_view),
                                        childAtPosition(
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.admin_stat_txt_username), withText("owalla3"),
                        childAtPosition(
                                allOf(withId(R.id.admin_stat_view),
                                        childAtPosition(
                                                withId(R.id.player_list_recycler),
                                ...
                                3),
                        isDisplayed()));
        textView2.check(matches(withText("owalla3")));

        ViewInteraction textView3 = onView(
                allOf(withId(R.id.admin_stat_txt_difficulty), withText("hard"),
                        childAtPosition(
                                allOf(withId(R.id.admin_stat_view),
                                        childAtPosition(
                                                withId(R.id.player_list_recycler),
                                ...
                                4),
                        isDisplayed()));
        textView3.check(matches(withText("hard")));
